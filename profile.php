                    ...
                    <form action="profile.php" method="post">
                        <div class="dashboard-profile">
                            ...
                            <div class="left-profile">
                                <span><label>PatientID:</label><p><?php echo $person_id?></p></span>
                                <span><label>Username:</label><p><?php echo $uname?></p></span>
                                <span><label>Password:</label><p><?php echo $pass?></p></span>
                                <span><label>Plan:</label><p><?php echo $plan?></p></span>
                                <span><label>Contact:</label><p><?php echo $contact?></p></span>
                            </div>
                            <div class="left-profile">
                                <span><label>Name:</label><p><?php echo $fname." ".$lname?></p></span>
                                <span><label>Date of birth:</label><p><?php echo $dob?></p></span>
