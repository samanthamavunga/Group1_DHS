                    ...
                    <form action="profile.php" method="post">
                        <div class="dashboard-profile">
                            ...
                            <div class="left-profile">
                                <span><label>New Username:</label><p><?php echo $uname?></p></span>
                                <span><label>New Password:</label><p><?php echo $pass?></p></span>
                                <span><label>New Location</label><p><?php echo $plan?></p></span>
                                <span><label>New Contact:</label><p><?php echo $contact?></p></span>
                            </div>
