<?php require("database_credentials.php");
    ...
    $sql = "Select patient_id, Diabetes_status, HBP_status from patient where patient_id='$pid'";
    ...
    if($results->num_rows==1){
        ...
        $diabetes_status=$rows["Diabetes_status"];
        $hbp_status=$rows["HBP_status"];
    }
?>
<!DOCTYPE html>
<html>
            ...
            <div class="dashboard">
                ...
                <div class="display-dashboard">
                    <form action="messagecoach.php" method="post">
                        <div class="dashboard-healthstatus">
                            <span class="profile-pic"><img src="images/user-interface.png" alt="ui" class="profile-avatar"> </span> 
                            <div class="left-profile">
                                <span><label>PatientID:</label><p><?php echo $patientID?></p></span>
                                <span><label>Diabetes status:</label><p><?php echo $diabetes_status?></p></span>
                                <span><label>High Blood status:</label><p><?php echo $hbp_status?></p></span>
                            </div>
                            <input type="submit" name="messagetocoach" value="Message Coach" />
                        </div>
                    </form>
                </div>
            </div>
